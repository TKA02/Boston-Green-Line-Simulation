...
The hardest part of this project was implementing the interface for MetroSim, 
specifically how to effectively read in the necessary information from each 
file and being able to manipulate the stream if the user inputed a commands.txt
. I had trouble loopily reading in data from the file without getline() reading
in an extra empty string and creating a loop that will read in commands but 
stop at the end of the file. 

Time spent on the homework:
The project took me 30 hours.